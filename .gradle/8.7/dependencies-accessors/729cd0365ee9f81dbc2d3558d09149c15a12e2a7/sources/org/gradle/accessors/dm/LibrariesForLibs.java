...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class BiometricLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v110</b> with <b>androidx.biometric:biometric</b> coordinates and
         * with version reference <b>androidxBiometric</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV110() {
            return create("biometric.v110");
        }

        /**
         * Dependency provider for <b>v120alpha05</b> with <b>androidx.biometric:biometric</b> coordinates and
         * with version reference <b>biometricVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV120alpha05() {
            return create("biometric.v120alpha05");
        }

        /**
         * Dependency provider for <b>v140alpha02</b> with <b>androidx.biometric:biometric</b> coordinates and
         * with version reference <b>androidxBiometricVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV140alpha02() {
            return create("biometric.v140alpha02");
        }
    ...
    public static class FirebaseAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2210</b> with <b>com.google.firebase:firebase-auth</b> coordinates and
         * with version reference <b>firebaseAuthVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV2210() {
            return create("firebase.auth.v2210");
        }
    ...
    public static class FirebaseBomLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v3211</b> with <b>com.google.firebase:firebase-bom</b> coordinates and
         * with version reference <b>firebaseBomVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV3211() {
            return create("firebase.bom.v3211");
        }
    ...
    public static class FirebaseFirestoreLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2450</b> with <b>com.google.firebase:firebase-firestore</b> coordinates and
         * with version reference <b>firebaseFirestoreVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV2450() {
            return create("firebase.firestore.v2450");
        }
    ...
    public static class LifecycleRuntimeKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public Provider<MinimalExternalModuleDependency> getV261() {
            return create("lifecycle.runtime.ktx.v261");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxBiometricVersion</b> with value <b>1.4.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxBiometricVersion() { return getVersion("androidxBiometricVersion"); }
        ...
        /**
         * Version alias <b>biometric</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>biometricVersion</b> with value <b>1.2.0-alpha05</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBiometricVersion() { return getVersion("biometricVersion"); }
        ...
        /**
         * Version alias <b>firebaseAuthVersion</b> with value <b>22.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseBomVersion</b> with value <b>32.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseFirestoreVersion</b> with value <b>24.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesBasement</b> with value <b>18.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
