...
public class RideListFragment extends Fragment {
    ...
    private tn.esprit.cov.Adapter.RideListAdapter rideListAdapter;
            ...
            public void run() {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        rideListAdapter = new tn.esprit.cov.Adapter.RideListAdapter(rideList, getContext());  // Create an adapter
